...
REGISTRY = {
    ...
    'results/rule54_g_sensor_gate_20260924.json': {p: p for p in (
        'docs/research/protocols/2026-09-24-rule54-g-sensor-gate.md',
        'experiments/rule54_g_sensor_gate_20260924/run.py',
    ...
    'results/observer_orbit_preflight_20260924_seal.json': {p: p for p in (
        ...
        'experiments/observer_orbit_preflight_20260924/verify.py',
        'docs/research/protocols/observer-orbit-preflight-20260924.md')},
    'results/observation_discovery_20260923.json': {p: p for p in (
        'experiments/observation_discovery_20260923/run.py',
        'experiments/observation_discovery_20260923/verify.py',
        'docs/research/protocols/observation-discovery-20260923.md')},
    'results/masked_history_sensing_20260923.json': {p: p for p in (
        ...
        'src/groovy/ca.py')},
    'results/delayed_repair_feasibility_20260923.json': {p: p for p in (
        ...
        'src/groovy/ca.py')},
    'results/return_target_20260923.json': {p: p for p in (
    ...
    'results/representation_case_studies_20260921.json': {p: p for p in (
        ...
        'results/depth_one_certificate_20260911.json', 'results/full_shift_depth_two_20260911.json')},
    'results/nakamura_retention_20260921.json': {p: p for p in (
        'scripts/verify_nakamura_retention.py', 'src/groovy/ca.py',
        'docs/research/protocols/nakamura-retention-20260921.md')},
    'results/nakamura_local_retention_20260921.json': {p: p for p in (
        'scripts/verify_nakamura_local_retention.py', 'scripts/verify_nakamura_retention.py',
    ...
    'results/dense_defect_algebra_20260918/summary.json': {
        ...
        'evaluate': 'experiments/dense_defect_algebra_20260918/evaluate.py',
        'rows': 'results/dense_defect_algebra_20260918/rows.json',
        'controls': 'results/dense_defect_algebra_20260918/controls.json',
        'pairs': 'results/dense_defect_algebra_20260918/pairs.json',
        'algebra': 'results/dense_defect_algebra_20260918/algebra.json'},
    'results/defect_algebra_20260918/summary.json': {
        'protocol': 'docs/research/protocols/2026-09-18-defect-algebra.md',
        'run': 'experiments/defect_algebra_20260918/run.py',
        'evaluate': 'experiments/defect_algebra_20260918/evaluate.py',
        'rows': 'results/defect_algebra_20260918/rows.json',
        'controls': 'results/defect_algebra_20260918/controls.json'},
