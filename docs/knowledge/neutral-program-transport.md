...
An instruction can circulate on a persistent encoded background while the represented data stays fixed. This is endogenous program dynamics, but its variation is dormant on that data image. It does not establish autonomous revision of the represented Rule32 law, learning, repair or a naturally generated dimensional tower.
