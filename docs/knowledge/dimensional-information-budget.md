...
The quotient-stripe encoding has exactly 2^(2n-1) possible n-by-n patches. A fixed-interface two-rail patch has exactly 2^n. Both counts are proved and enumerated in the [research note](../research/2026-09-09-program-edit-locality.md).
