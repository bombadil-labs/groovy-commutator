...
The [checkpoint](../research/2026-09-10-stored-correction-transport.md) includes the local proof, 8,192 exhaustive physical local checks, full finite fields for all256 rules and all8 width-three source states, and the retained witness. Its separately frozen audit passes 51,202 assertions.
