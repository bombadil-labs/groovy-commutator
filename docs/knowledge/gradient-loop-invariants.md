...
Local zero curl and the existence of a periodic binary potential remain distinct. Nonzero loop sectors have twisted potentials on the infinite cover and require no arbitrary curl-defect update. This invariant depends on topology and does not establish intrinsic dimension, prime factors, or affordable control. The [next intervention protocol](../research/protocols/gradient-intervention-costs-20260910.md) is separately frozen and unrun.
