# Transverse differences alone discard causally necessary column baselines

For the unchanged ordered axial G family and observation T(X)(x,y)=X(x,y) XOR X(x,y+1), exactly six of the66 replication-compatible sources admit an autonomous update:0,150,170,204,240,255. Constants give zero differences,204 gives identity,170/240 give diagonal shifts, and150 gives3-by3 parity. Three close at radius zero; all six close at radius one.
...
This is specific to the declared observation and source family. The copied-field symmetry remains invariant. A different observation or additional state may close; merely widening the neighborhood of T cannot resolve these full-field ambiguities. The completed [full-gradient comparison](../research/2026-09-10-full-gradient-closure.md) retains both spatial differences at an explicit two-bit-per-site cost and admits ten of the 66 sources. It changes the observation and does not weaken the transverse-only obstruction.
