...
The [earlier routing checkpoint](2026-09-09-selector-two-lift.md) used the source program throughout the target background. Its interface encoding worked only when that program preserved uniform zero and uniform one: 64 ECA rules.
