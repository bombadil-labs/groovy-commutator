...
The frozen contract is in [protocols/conservative-online-suffix-learner-20260910.md](protocols/conservative-online-suffix-learner-20260910.md). The implementation lives in `src/groovy/online_suffix.py`; `scripts/check_conservative_online_suffix.py` exercises hand-checkable traces.
