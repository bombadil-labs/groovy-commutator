...
1. **P6's boundary-concentration clause was frozen without a threshold and was not scored.** It is now scored numerically: the two named boundaries (drain/crystalline and structured/noisy) carry 452 of 1,588 reflection disagreements (28.46%) and 518 of 1,978 complement disagreements (26.19%), and two unnamed boundaries (crystalline/structured, noisy/structured) are populated. The clause is **unsupported**. The agreement-rate and commute-exactness clauses stand.
