# Historical agent-guide snapshot — not current instructions

Preserved from main `5c4f6d6d382f571a47cb38aa751f781a7a9cd91a` during the
2026-09-21 reset. The text below is historical, including its old task routing.
Current guidance is [AGENTS.md](../../../AGENTS.md) and
[START_HERE](../START_HERE.md). Links in the snapshot were originally relative
to the repository root. The snapshot is not a newly validated results ledger.
