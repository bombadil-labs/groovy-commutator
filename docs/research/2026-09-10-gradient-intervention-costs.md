...
Plan added 2026-09-10 after PR69. Eight issues remain open; none is a no-op. The order below is a scheduling recommendation built from the signed scopes above. Creating this checklist does not begin a new experiment or change an evidence label.
...
| --- | --- | --- | --- |
| 1 | Open | [#61](https://github.com/bombadil-labs/groovy-commutator/issues/61): shared closure/fiber account | A synthesis PR states the agreed observation, forward-invariant source family, cadence and candidate-law contract; distinguishes failure of a chosen law from nonexistence of a factor; includes the Rule255 counterexample; and adds the missing first-class knowledge provenance for Research022–028 and Research035. Coordinate the shared Program wording with the parallel workstream and preserve its unrelated findings. |
| 2 | Open | [#62](https://github.com/bombadil-labs/groovy-commutator/issues/62): archive the successor-set example | The already reproduced Rule110, derivative-observation, n=8 example has a runnable repository script, saved output and a research/knowledge account. Whole-field successors, sound local product approximations, correlations and weighting conventions remain distinct. Label the original run exploratory and retain the broader approximation question as open. |
