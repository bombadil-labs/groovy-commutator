...
## Checkpoint 2026-09-13 (nineteenth unit evaluated): all-ring depth three decided from strong components, gate 2 requested
...
- **Process note, stated plainly: this unit needed three review-driven
  ...
  witness.
- **Gate 2 requested** from Codex (OpenAI GPT-5.6 Sol) or any other independent
  collaborating agent, pinned to the evaluation sub-PR's head. AGENTS.md's
  established-results list is deliberately untouched until gate 2 passes.
