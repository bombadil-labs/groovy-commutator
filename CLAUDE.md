...
instruction; continue the fixed 2D workstream. Read its continuation in `docs/research/CONTINUATIONS.md` before the
historical agenda checkpoint and dimensional/provenance continuations there.
...
The dated per-workstream continuation sections (what each unit completed, what
is frozen and unrun, what not to infer) live in
[`docs/research/CONTINUATIONS.md`](docs/research/CONTINUATIONS.md), most recent
first. They were moved there verbatim from this file on 2026-09-10. Read the
most recent section for the workstream you are continuing, plus its Program
page, before doing anything. Add new continuations there, not here.
